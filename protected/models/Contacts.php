 ...
 * @property integer $type   1 : Personal Account , 2 : Business Account 
 */
class Contacts extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('number, fax, type', 'numerical', 'integerOnly'=>true),
			array('name, email', 'length', 'max'=>250),
			array('image, home_address, website', 'safe'),
                        array('image', 'file','types'=>'jpg, gif, png', 'allowEmpty'=>true, 'on'=>'update'), 
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, email, number, image, home_address, fax, website, type', 'safe', 'on'=>'search'),
		);
	}
